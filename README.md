...
4. validateNullList(List<T> list) - Гарантирует корректность работы методов, принимающих список, путем проверки на нулевые ссылки.
...
3. NumberFormatException 
   ...
   - В методе valIsNumber(): баллы участников содержат нечисловые значения (возвращает false)
